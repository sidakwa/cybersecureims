  ...
  return (
    <Routes>
      ...
      <Route path="/" element={
        ...
        <Route path="priority-actions" element={<PriorityActionDashboard />} />
        <Route path="scorecard" element={<ComplianceScorecard />} />
        <Route path="reports" element={<ReportPortal />} />
        
        {/* GRC Routes */}
        <Route path="soa" element={<StatementOfApplicability />} />
        <Route path="documents" element={<DocumentManagement />} />
        <Route path="legal" element={<LegalRegisters />} />
        <Route path="hr" element={<HumanResources />} />
        
        {/* Audit Manager Routes */}
        <Route path="audits/portfolio" element={<AuditPortfolio />} />
        <Route path="audits/findings" element={<FindingsRegister />} />
        <Route path="audits/evidence" element={<EvidenceLibrary />} />
        <Route path="audits/actions" element={<ActionTracker />} />
        <Route path="audits/calendar" element={<AuditCalendar />} />
        <Route path="audits/metrics" element={<AuditMetrics />} />
        
        {/* Control Assurance Routes */}
        <Route path="controls" element={<ControlLibrary />} />
        <Route path="uci-controls" element={<UCIControls />} />
        <Route path="uci-controls-full" element={<UCIControlsFull />} />
        <Route path="csi-items" element={<CSIItems />} />
        <Route path="work-packages" element={<WorkPackageManagement />} />
        
        {/* Risk Management Routes */}
        <Route path="risk-assessment" element={<CyberRiskAssessment />} />
        <Route path="risk-mapping" element={<RiskMapping />} />
        <Route path="vulnerabilities" element={<VulnerabilityTracker />} />
        <Route path="pen-tests" element={<PenTestTracker />} />
        <Route path="vendors" element={<VendorRiskManagement />} />
        
        {/* Security Operations Routes */}
        <Route path="incidents" element={<SecurityIncidents />} />
        <Route path="assets" element={<AssetInventory />} />
        <Route path="bc-dr" element={<BcDrPlans />} />
